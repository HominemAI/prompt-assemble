...
A comprehensive example system demonstrating variable hierarchy, nested prompt inclusion, and tag-based prompt
injection. This example shows how to build complex, reusable prompt systems with modular components.
